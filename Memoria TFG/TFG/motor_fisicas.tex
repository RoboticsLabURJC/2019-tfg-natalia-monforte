...
\begin{itemize}
    ...
    \item \textbf{Velocidad lineal máxima:} es la velocidad lineal máxima que puede alcanzar un robot. Concede realismo al modelo, puesto que termina con la asunción de aceleración infinita.
    \item \textbf{Velocidad angular máxima:} es la velocidad angular máxima que puede alcanzar un robot. Concede realismo al modelo, puesto que termina con la asunción de aceleración infinita.
...
\begin{itemize}
    ...
    \caption{Diseño controlador PD en velocidad angular horizontal para drone\footnotemark}
    ...
    \caption{Diseño controlador PD en velocidad angular horizontal para robot terrestre\footnotemark}
    ...
    \caption{Diseño controlador PD en posición para la altura\footnotemark}
