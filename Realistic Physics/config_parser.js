...
export function createElement(tag, obj){
  ...
  var element;
  if (tag === 'a-robot'){
    arrayInitialPos.push({id:obj['attr']['id'],position:obj['attr']['position'],rotation:obj['attr']['rotation'], vmax:obj['attr']['vmax'], wmax:obj['attr']['wmax'], fmax:obj['attr']['fmax'],tmax:obj['attr']['tmax']});     
